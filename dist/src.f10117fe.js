...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/model/Eventing.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      ...
      var handlers = _this.events[eventName] || []; // if undefined then []
...
},{}],"src/model/Collection.ts":[function(require,module,exports) {
"use strict";
...
},{"axios":"node_modules/axios/index.js","./Eventing":"src/model/Eventing.ts"}],"src/model/Model.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/model/ApiSync.ts":[function(require,module,exports) {
"use strict";
...
exports.User = User;
},{"./Model":"src/model/Model.ts","./Attributes":"src/model/Attributes.ts","./ApiSync":"src/model/ApiSync.ts","./Eventing":"src/model/Eventing.ts","./Collection":"src/model/Collection.ts"}],"src/view/View.ts":[function(require,module,exports) {
"use strict";
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    } // abstract eventsMap(): { [key: string]: () => void }; //we dont need to compalsuryly implement it in any kind of userform so commenting it from abstract//optional method
    ...
    value: function render() {
      ...
      this.bindEvents(templateElement.content); //content=>document fragment
...
},{"./View":"src/view/View.ts"}],"src/model/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/model/UserList.ts":[function(require,module,exports) {
"use strict";
...
var UserShow_1 = require("../view/UserShow");
...
},{"../view/UserShow":"src/view/UserShow.ts","./CollectionView":"src/model/CollectionView.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict"; // import { UserEdit } from './view/UserEdit';
...
var UserList_1 = require("./model/UserList");
...
users.fetch();
},{"./model/Collection":"src/model/Collection.ts","./model/User":"src/model/User.ts","./model/UserList":"src/model/UserList.ts"}],"../../../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
